<div id="alert-additional-content-2"
    ...
    <div class="mt-2 mb-4 text-sm">
        ...
        <ul class="mt-1.5 list-disc list-inside">
            <li>Todas as categorias relacionadas a essa tecnologia serão excluidas permanentemente.</li>
    ...
    <div class="flex">
        <button type="button" id="delete_technology"
...
<script>
    ...
    const deleteTechnology = async () => {
        try {
            ...
            const response = await axiosInstance.delete(`${baseUrl}/api/technologies/${id}`)
