                    ...
                    <tr
                        ...
                        <td class="px-6 py-4">
                            <div class="flex gap-4">
                                <a  href="${baseUrl}tecnologias/${item.id}/editar" class="font-medium text-green-500 dark:text-blue-500 hover:text-blue-700">
                                    <i class="mdi mdi-pencil text-xl"></i>
                                </a>
                                <a  href="${baseUrl}tecnologias/${item.id}/delete" class="font-medium text-red-600 dark:text-blue-500 hover:text-blue-700">
