...
<head>
    ...
    <!-- axios  -->
    <script type="text/javascript" src="<?= base_url('libs/axios.min.js') ?>"></script>
    <!-- axios config -->
    <script type="text/javascript" src="<?= base_url('utils/axiosConfig.js') ?>"></script>
    <!-- sweetAlert -->
    <script src="<?= base_url('libs/sweetAlert2.js') ?>"></script>
    <!-- functions config -->
    <script type="text/javascript" src="<?= base_url('utils/functions.js') ?>"></script>
    <!-- dashboards -->
    <script type="text/javascript" src="<?= base_url('utils/dashboard.js') ?>"></script>
    <!-- dashboards -->
    <script type="text/javascript" src="<?= base_url('utils/quiz.js') ?>"></script>
    <!-- chartJS -->
